...
class AmityCLI(cmd.Cmd):
    ...
    @docopt_cmd
    def do_save_state(args):
        """ Usage: save_state [--db=sqlite_database] """
        amity_print(amity.save_state(args['--db']))

    @docopt_cmd
    def do_load_state(args):
